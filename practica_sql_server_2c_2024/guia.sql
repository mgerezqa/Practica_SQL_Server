...
-- 20. Escriba una consulta sql que retorne un ranking de los mejores 3 empleados del
-- 2012
...
-- menos de 10 facturas en el año el calculo del puntaje sera el 50% de cantidad de
-- facturas realizadas por sus subordinados directos en dicho año.
-- 21. Escriba una consulta sql que retorne para todos los años, en los cuales se haya hecho
-- al menos una factura, la cantidad de clientes a los que se les facturo de manera
-- incorrecta al menos una factura y que cantidad de facturas se realizaron de manera
-- incorrecta. Se considera que una factura es incorrecta cuando la diferencia entre el
-- total de la factura menos el total de impuesto tiene una diferencia mayor a $ 1
-- respecto a la sumatoria de los costos de cada uno de los items de dicha factura. Las
-- columnas que se deben mostrar son:
--  Año
--  Clientes a los que se les facturo mal en ese año
--  Facturas mal realizadas en ese año
-- 22. Escriba una consulta sql que retorne una estadistica de venta para todos los rubros
-- por trimestre contabilizando todos los años. Se mostraran como maximo 4 filas por
-- rubro (1 por cada trimestre).
...
-- El resultado debe ser ordenado alfabeticamente por el detalle del rubro y dentro de
-- cada rubro primero el trimestre en el que mas facturas se emitieron.
...
-- d. Cantidad de productos que componen directamente al producto más vendido
